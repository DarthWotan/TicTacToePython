...
def bot(player):
    ...
    while not valid:
        ...
        if board[position_bot] == "-":
            valid = True
    board[position_bot] = player
    display_board()

def check_rows_bot():
    check_1 = board[0] == board[1] != "-"
    pos_1 = 2
    check_2 = board[0] == board[2] != "-"
    pos_2 = 1
    check_3 = board[1] == board[2] != "-"
    pos_3 = 0

    check_4 = board[3] == board[4] != "-"
    pos_4 = 5
    check_5 = board[3] == board[5] != "-"
    pos_5 = 4
    check_6 = board[4] == board[5] != "-"
    pos_6 = 3

    check_7 = board[6] == board[7] != "-"
    pos_7 = 8
    check_8 = board[6] == board[8] != "-"
    pos_8 = 7
    check_9 = board[7] == board[8] != "-"
    pos_9 = 6

    if check_1 and board[pos_1] != "X" and board[pos_1] != "O":
        return pos_1
    elif check_2 and board[pos_2] != "X" and board[pos_2] != "O":
        return pos_2
    elif check_3 and board[pos_3] != "X" and board[pos_3] != "O":
        return pos_3

    elif check_4 and board[pos_4] != "X" and board[pos_4] != "O":
        return pos_4
    elif check_5 and board[pos_5] != "X" and board[pos_5] != "O":
        return pos_5
    elif check_6 and board[pos_6] != "X" and board[pos_6] != "O":
        return pos_6

    elif check_7 and board[pos_7] != "X" and board[pos_7] != "O":
        return pos_7
    elif check_8 and board[pos_8] != "X" and board[pos_8] != "O":
        return pos_8
    elif check_9 and board[pos_9] != "X" and board[pos_9] != "O":
        return pos_9

    return

def check_columns_bot():
    check_1 = board[0] == board[3] != "-"
    pos_1 = 6
    check_2 = board[0] == board[6] != "-"
    pos_2 = 3
    check_3 = board[3] == board[6] != "-"
    pos_3 = 0

    check_4 = board[1] == board[4] != "-"
    pos_4 = 7
    check_5 = board[1] == board[7] != "-"
    pos_5 = 4
    check_6 = board[4] == board[7] != "-"
    pos_6 = 1

    check_7 = board[2] == board[5] != "-"
    pos_7 = 8
    check_8 = board[2] == board[8] != "-"
    pos_8 = 5
    check_9 = board[5] == board[8] != "-"
    pos_9 = 2
...
def check_diagonals_bot():
    check_1 = board[0] == board[4] != "-"
    pos_1 = 8
    check_2 = board[0] == board[8] != "-"
    pos_2 = 4
    check_3 = board[4] == board[8] != "-"
    pos_3 = 0

    check_4 = board[2] == board[4] != "-"
    pos_4 = 6
    check_5 = board[2] == board[6] != "-"
    pos_5 = 4
    check_6 = board[4] == board[6] != "-"
    pos_6 = 2
